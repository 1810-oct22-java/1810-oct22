...
public class ViewApprovedServlet extends HttpServlet{
  ...
  throws ServletException, IOException { 
		  ...
		  out.println("<a href ='s2?username="+username1+"'>Approve/Deny Employee Reimbursement Requests</a>"+"<br>");   
		  out.println("<a href ='s4?username="+username1+"'>View Denied Employee Reimbursement Requests</a>" +"<br>");
		  out.println("<h1>Approved Employee Reimbursement Requests</h1>");
	 }
...
ReimbursementDao RD = new ReimbursementDao();
  ...
  List<ers_reimbursement> list=RD.findAll11();  
  out.println("<!DOCTYPE html>\r\n" + 
	  		...
	  		"                    </li>\r\n" + 
	  		"                    <li class=\"nav-item\">\r\n" + 
	  		"                      <a class=\"nav-link\" id=\"viewdenied\" href='s4?username="+username+"'\">View Denied Reimbursement Requests</a>\r\n" + 
	  		"                    </li>    \r\n" + 
	  		"                    <li class=\"nav-item\">\r\n" + 
