...
public class ConnectionFactory {
	...
	public Connection getConnection() {
		...
		String path = "C:/Users/Owner/eclipse-workspace/Project_1_William_Robinson/src/main/Resources/database.properties";
		///Project_1_William_Robinson/src/main/Resources/database.properties
		...
		//String path = "src/main/Resources/database.properties";
			...
			try {
				...
				conn = DriverManager.getConnection(
						...
						prop.getProperty("usr"), //username
						prop.getProperty("pwd"));  //password
			} catch (IOException e) {
				e.printStackTrace();
