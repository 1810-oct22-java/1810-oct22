...
/**
 * Factory to serve only one connetion to the db
 * 
 * @author Phil
 *
 */
public class ConnectionFactory {
	...
	public Connection getConnection() {
		...
		String path="C:/Users/Phil/my_git_repos/Revature/Project0/src/main/resources/db.properties";
		
		try {
			prop.load(new FileReader(path));
			
			// the following line of code uses reflection and the 
			// .properties file in order ot instantiate our driver
