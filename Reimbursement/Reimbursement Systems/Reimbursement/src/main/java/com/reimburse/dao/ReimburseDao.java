...
//			PreparedStatement ps = conn.prepareStatement(sql);
//			ps.setInt(1, obj.getAmount());
//			log.trace("update executed 1");
//			ps.setTimestamp(2, obj.getSubmitted());
//			log.trace("update executed 2");
//			ps.setTimestamp(3, obj.getResolved());
//			log.trace("update executed 3");
//			ps.setString(4, obj.getDescription());
//			log.trace("update executed 4");
//			ps.setInt(5, obj.getAuthor());
//			log.trace("update executed 5");
//			ps.setInt(6,  obj.getResolver());
//			log.trace("update executed 6");
//			ps.setInt(7, obj.getStatus_id());
//			log.trace("update executed 7");
//			ps.setInt(8, obj.getType_id());
//			log.trace("update executed 8");
//			ps.setInt(9, obj.getId());
//			log.trace("update executed 9");
//			ps.executeUpdate();
...
//			conn.setAutoCommit(false);
//			
//			String sql = "INSERT INTO ERS_USERS (REIMB_AMOUNT, REIMB_DESCRIPTION, REIMB_SUBMITTED, REIMB_RESOLVED, REIMB_AUTHOR, REIMB_RESOLVER, REIMB_STATUS_ID, REIMB_TYPE_ID)"
//					+ " VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
//			
//			String[] keyNames = {"REIMB_ID"};
//			
