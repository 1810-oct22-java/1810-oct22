...
INSERT INTO BANK_ACCOUNT(ACCOUNT_TYPE,USER_ID,BALANCE) VALUES(1,83,0);
commit;

SELECT * FROM BANK_USER ORDER BY USER_ID;
SELECT * FROM BANK_ACCOUNT ORDER BY ACCOUNT_ID;
...
DELETE FROM BANK_USER WHERE USER_ID = 1;
DELETE FROM BANK_ACCOUNT WHERE USER_ID = 1;
