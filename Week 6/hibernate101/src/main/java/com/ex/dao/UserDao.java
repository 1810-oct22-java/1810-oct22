...
public class UserDao {
	 ...
	 * and assigns it to a new identifier, which results in a duplicate
	...
	/*
	 * Session.load()
	 * - the load method provides a way of retrieving persitant
	 * instance if you know its id. Load() takes a class object
	 * and loads the state into a new instantiated instance of that 
	 * class in a persistent state
	 * - Load() will throw an unrecoverable exception if it attempts to load
	 * a nonexistent row
