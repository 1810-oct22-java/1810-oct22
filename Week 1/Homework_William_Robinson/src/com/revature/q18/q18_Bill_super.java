...
public abstract class q18_Bill_super {

	public abstract boolean hasUpperCaseChar(String s);
	public abstract char toUpperCase(String s);
	public abstract Integer convertStringtoInteger(String s);
	/*
